...
import numpy as np
from mol_gen.models.GeoLDM.egnn.models import (
    EGNN_dynamics_QM9,
    EGNN_encoder_QM9,
    EGNN_decoder_QM9,
)

from mol_gen.models.GeoLDM.equivariant_diffusion.en_diffusion import (
...
def get_latent_diffusion(args, device, dataset_info, dataloader_train):
    ...
    if args.ae_path is not None:
        fn = (
            ...
            if first_stage_args.ema_decay > 0
            else "generative_model.npy"
        )
